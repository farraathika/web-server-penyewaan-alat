...
<body>
    <main class="w-full min-h-[100vh] pb-32 flex flex-row bg-gray-200">
        <div class="container-sidebar w-[20%]">
            <?php include 'sidebar.php';?>
        </div>
        <div class="w-[80%] flex flex-col gap-2 pr-6 pl-10">
            <nav class="navbar flex flex-row shadow-xl justify-between items-center w-full py-1 h-16 bg-white my-4 px-4 rounded-lg">
                ...
                <div class="flex flex-row justify-center items-center gap-2">
                    ...
                    <p class="text-[13px] font-medium text-gray-800"><?php echo $_SESSION['admin_name'];
?></p>
                </div>
            </nav>
            <div class="container flex flex-col gap-4">
                <div class="grid grid-cols-3 gap-4">
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        ...
                        <p class="text-3xl font-semibold text-gray-900"><?php echo $totalCustomers; ?></p>
                    </div>
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        <h2 class="text-xl font-bold text-gray-700">Total Stock</h2>
                        <p class="text-3xl font-semibold text-gray-900"><?php echo $totalStock; ?></p>
                    </div>
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        <h2 class="text-xl font-bold text-gray-700">Total Revenue</h2>
                        <p class="text-3xl font-semibold text-gray-900"><?php echo number_format($totalRevenue, 2); ?></p>
                    </div>
                </div>
                <div class="bg-white shadow-lg rounded-lg p-6">
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                <?php while ($row = $recentTransactionsResult->fetch_assoc()) {?>
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['id_transaksi']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['nama_pelanggan']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['nama_produk']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['nama_admin']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['jumlah']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['tanggal_sewa']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['tanggal_kembali']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo number_format($row['total_harga'], 2); ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200 text-center"><?php echo $row['status']; ?></td>
                                    </tr>
                                <?php }?>
                            </tbody>
                        </table>
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                <?php while ($row = $stockDetailsResult->fetch_assoc()) { ?>
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><?php echo $row['nama_produk']; ?></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><?php echo $row['stok_tersisa']; ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
